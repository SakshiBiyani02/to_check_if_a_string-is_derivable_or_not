...
## Conclusion: 
In this program, we have implemented a bottom-up parser using a queue-based approach to simulate the parsing of a string against a given context-free grammar (CFG). The key feature of 
